...
|Action| Rationale|
| ----------- | ----------- |
|Monitor all students with entrance scores of 18 and above|The clustering and sequential pattern model tells us that students considered ‘at-risk’ generally scored 18 or more for their entrance test scores.|
...
The team recommends monitoring as some students may have difficulty adjusting to a new academic environment and struggle initially.|
